...
def deliverable_detail_submit(request):
    if request.POST.get('deploy_button'):
        return render(request, 'deploy_placeholder.html')
...
def save_detail(request):
    ...
    if request.POST['processing_complete_date'] == '':
        temp_processing_complete_date = None
    else:
        temp_processing_complete_date = datetime.strptime(request.POST['processing_complete_date'], '%m/%d/%Y')
    ...
    if request.POST['deliverable_id'] == '':
        my_deliverable_detail_record = Deliverable(course_name=request.POST['course_name'],
                                                   ...
                                                   processing_complete_date=temp_processing_complete_date,
        ...
        my_deliverable_detail_record.processing_complete_date = temp_processing_complete_date
